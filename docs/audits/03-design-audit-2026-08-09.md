...
No item below is implemented. Rendered evidence unless marked _(source)_.
...
Reply with item IDs, e.g. _"Approve VAR-01, VAR-04, VAR-D1"_ · _"Approve all
P2"_ · _"Reject VAR-12; revise VAR-03 using option (b)"_. The ten CMCs above
