...
export function AboutSection() {
  return (
    <SettingsSection title="About">
      <Field label="Version">
        <span className="font-body text-sm tabular-nums text-silver">v{APP_VERSION}</span>
      </Field>
      <Divider />
      <div className="flex flex-col gap-1">
        ...
        <p className="font-body text-xs leading-relaxed text-silver">
          ...
          Developer marks via thesvg.org and Simple Icons. Built on Next.js and Supabase.
        </p>
      </div>
      <Divider />
      <p className="font-body text-xs leading-relaxed text-silver">
        VIZION is a VASEY/AI product. License and security policy live in the repository
        (LICENSE · SECURITY.md).
      </p>
    </SettingsSection>
  );
